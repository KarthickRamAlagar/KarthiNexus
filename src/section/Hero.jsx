...
// import JavaScriptLogo from "../components/JSLogo.jsx";
...
//               <JavaScriptLogo
//                 position={[-15, 12, 3]} // start position
//                 finalPos={
//                   isSmall
//                     ? [-7, -9, -14]
//                     : isMobile
...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* TEXT CONTENT */}
      <div className="w-full mx-auto flex flex-col sm:mt-36 mt-20 c-space gap-3">
        <h4 className="sm:text-5xl text-2xl ml-5 font-medium text-white text-center font-generalsans">
          Hi, I am KarthiKeyan <span className="waving-hand">👋</span>
        </h4>
